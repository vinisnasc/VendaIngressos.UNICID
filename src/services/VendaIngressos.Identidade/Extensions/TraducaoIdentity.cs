...
{
    public class TraducaoIdentity : IdentityErrorDescriber
    {
        ...
        public override IdentityError ConcurrencyFailure() { return new IdentityError { Code = nameof(ConcurrencyFailure), Description = $"Falha de concorrencia otimista, o objeto foi modificado." }; }
        ...
        public override IdentityError UserLockoutNotEnabled() { return new IdentityError { Code = nameof(UserLockoutNotEnabled), Description = $"O lockout não estáhabilitado para este usuário." }; }
        ...
        public override IdentityError PasswordTooShort(int lenght) { return new IdentityError { Code = nameof(PasswordTooShort), Description = $"As senhas devem conter ao menos {lenght} caracteres." }; }
        ...
        public override IdentityError PasswordRequiresDigit() { return new IdentityError { Code = nameof(PasswordRequiresDigit), Description = $"As senhas devem conter ao menos um digito." }; }
